    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          @endif
          <form class="form-horizontal" action="{{ URL('admin/teacher') }}" accept-charset="UTF-8" method="post">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="avatar" value="{{ Input::old('avatar') }}" class="form-control" placeholder="" required>
                </div>
              </div>
              <div class="form-group">
